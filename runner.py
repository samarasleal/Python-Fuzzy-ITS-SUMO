...
estatico = True
if estatico:
    PROGRAM = geraSinais(15,15,15,15) # A cada unidade de tempo no SUMO eh rodado um estado (posicao) deste vetor
else:
    ...
    with open("data/cross.rou.xml", "w") as routes:
        ...
        for i in range(N): # Cada via tera N chances de conseguir que um carro apareca no instante i
            ...
            if i < 21600: # Entre 0 e 6 da manha
                # Probabilidade de ocorrencia de carros nas vias por unidade de tempo. A direcao que o carro toma depois do sinal eh indiferente ate agora
                # Para cada passo [0,21600], a probabilidade de um carro ir de Norte a Sul eh de ~0.09%
                # http://www.profcardy.com.br/calculadoras/aplicativos.php?calc=14
